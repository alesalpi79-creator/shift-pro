    ...
    <div className="fade-in" style={{ 
      ...
      <div style={{ marginTop: '5rem', width: '100%', position: 'relative' }}>
        <div className="glass-panel" style={{ padding: '1rem', borderRadius: '2rem', overflow: 'hidden', boxShadow: '0 50px 100px -20px rgba(0,0,0,0.5)' }}>
          <div style={{ aspectRatio: '16/9', background: 'rgba(0,0,0,0.5)', borderRadius: '1.5rem', overflow: 'hidden', height: '400px', border: '1px solid rgba(255,255,255,0.05)', position: 'relative' }}>
             <video 
               src="/demo.mp4" 
               autoPlay 
               loop 
